...
pub const __loongarch_xlen: u32 = 64;
...
fn bindgen_test_layout_OrtCUDAProviderOptions() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OrtCUDAProviderOptions>())).tunable_op_max_tuning_duration_ms
                as *const _ as usize
        },
        56usize,
        concat!(
...
fn bindgen_test_layout_OrtROCMProviderOptions() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OrtROCMProviderOptions>())).tunable_op_max_tuning_duration_ms
                as *const _ as usize
        },
        56usize,
        concat!(
...
fn bindgen_test_layout_OrtApi() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OrtApi>())).CreateROCMProviderOptions as *const _ as usize
        },
        2040usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OrtApi>())).UpdateROCMProviderOptions as *const _ as usize
        },
        2048usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OrtApi>())).GetROCMProviderOptionsAsString as *const _ as usize
        },
        2056usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<OrtApi>())).ReleaseROCMProviderOptions as *const _ as usize
        },
        2064usize,
        concat!(
            "Offset of field: ",
